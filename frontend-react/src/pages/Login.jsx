...
const Login = () => {
    ...
    const handleVerifySubmit = async (e) => {
        e.preventDefault();
        await verifyEmailCode(loginEmail, verificationCode);
    };
                    ...
                    {step === 1 ? (
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-md-12 text-center">
                                        ...
                                        <div className="mt-20">
                                            ...
                                            <br />
                                            <span style={{ fontSize: '14px' }}><Link to="/forgot-password">Forgot Password?</Link></span>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <>
                            <div className="section-title text-center mb-40">
                                ...
                                <p>Please enter the 6-digit code sent to <strong>{loginEmail}</strong>.</p>
                            </div>
